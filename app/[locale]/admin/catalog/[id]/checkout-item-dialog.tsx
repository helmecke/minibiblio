...
export function CheckoutItemDialog({ itemId, itemTitle, catalogId }: CheckoutItemDialogProps) {
      ...
      <DialogContent className="sm:max-w-[525px]">
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3 p-2 bg-muted rounded text-sm">
                {itemTitle} <span className="text-muted-foreground">({catalogId})</span>
              </div>
            </div>
          ...
          <DialogFooter>
            <Button
              type="submit"
              disabled={loading || !formData.patron_id}
            >
